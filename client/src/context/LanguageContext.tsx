...
export function LanguageProvider({ children }: { children: ReactNode }) {
 ...
 const setScript = useCallback((newScript: Script) => {
 ...
 */
 const tKey = useCallback((key: string): string => {
 ...
 */
 const uz = useCallback((text: string): string => {
 if (!text) return text;
 ...
 */
 ...
 uz,
 t
 }), [script, uzScript, setScript, tKey, uz, t]);
