    ...
    <div className={`min-h-screen flex flex-col ${isReturnMode ? 'bg-warning-50 dark:bg-warning-900/10' : 'bg-gray-50 dark:bg-gray-900'}`}>
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-base lg:text-lg font-bold text-gray-900 dark:text-gray-100">
                {isReturnMode ? 'Qaytarish rejimi' : 'Kassa (POS)'}
              </h1>
              <p className="text-xs text-gray-500 dark:text-gray-400">
                {cart.length} ta mahsulot • {total.toLocaleString()} so'm
              </p>
            </div>
          </div>
      ...
      <div className="flex-1 flex flex-col lg:flex-row overflow-hidden gap-4 lg:gap-6 p-4 lg:p-6">
        ...
        <div className="flex-1 flex flex-col overflow-hidden">
          ...
          <div className="hidden lg:flex flex-1 bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 overflow-hidden flex-col shadow-sm">
            ...
            <div className="grid grid-cols-12 gap-3 px-6 py-4 bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-700 dark:to-gray-800 border-b border-gray-200 dark:border-gray-600">
              <div className="col-span-1 text-xs font-bold text-gray-600 dark:text-gray-400 uppercase tracking-wide">Kod</div>
              <div className="col-span-3 text-xs font-bold text-gray-600 dark:text-gray-400 uppercase tracking-wide">Mahsulot</div>
              <div className="col-span-2 text-xs font-bold text-gray-600 dark:text-gray-400 uppercase tracking-wide">Ombor</div>
              <div className="col-span-2 text-center text-xs font-bold text-gray-600 dark:text-gray-400 uppercase tracking-wide">Soni</div>
              <div className="col-span-2 text-right text-xs font-bold text-gray-600 dark:text-gray-400 uppercase tracking-wide">Narx</div>
              <div className="col-span-1 text-right text-xs font-bold text-gray-600 dark:text-gray-400 uppercase tracking-wide">Summa</div>
              <div className="col-span-1 text-center text-xs font-bold text-gray-600 dark:text-gray-400 uppercase tracking-wide">Amal</div>
            </div>
              ...
              {cart.length === 0 ? (
                <div className="flex items-center justify-center h-full text-gray-400 py-20">
                  <div className="text-center">
                    ...
                    <p className="text-sm text-gray-400 mt-1">Mahsulot qo'shish uchun qidiring</p>
                  </div>
                </div>
              ) : (
            ...
            {cart.length === 0 ? (
              <div className="flex items-center justify-center h-full text-gray-400 py-12">
                <div className="text-center">
                  ...
                  <p className="text-base font-medium">Savat bo'sh</p>
                  <p className="text-sm text-gray-400 mt-1">Mahsulot qo'shish uchun qidiring</p>
                </div>
              </div>
            ) : (
              cart.map((item) => (
                ...
                >
                  ...
                  <div className="grid grid-cols-3 gap-3">
                    <div>
                      <label className="text-xs font-black text-slate-700 dark:text-gray-400 block mb-1.5">Soni</label>
                      <input
                        type="text"
                    ...
                    <div>
                      <label className="text-xs font-black text-slate-700 dark:text-gray-400 block mb-1.5">Narx</label>
                      <input
                        type="text"
                    ...
                    <div>
                      <label className="text-xs font-semibold text-gray-500 dark:text-gray-400 block mb-1.5">Summa</label>
          ...
          <div className="lg:hidden fixed bottom-0 left-0 right-0 bg-white dark:bg-gray-800 border-t-2 border-gray-200 dark:border-gray-700 p-4 shadow-2xl z-20">
            <div className="flex items-center justify-between mb-3">
              <span className="text-sm font-semibold text-gray-600 dark:text-gray-400">Jami:</span>
              <span className="text-2xl font-black text-primary-700 dark:text-primary-400">
                {total.toLocaleString()} <span className="text-sm">so'm</span>
              </span>
            </div>
            <div className="grid grid-cols-3 gap-2">
              <button
                onClick={openSearch}
                className="flex flex-col items-center justify-center gap-1 py-3 bg-red-500 text-white rounded-xl hover:bg-red-600 transition-all font-semibold text-xs shadow-md active:scale-95"
              >
              ...
              <button
                ...
                className={`flex flex-col items-center justify-center gap-1 py-3 rounded-xl transition-all font-semibold text-xs shadow-md active:scale-95 ${
                  isReturnMode
              ...
              >
                ...
                <span>{isReturnMode ? 'Bekor' : 'Qaytarish'}</span>
              </button>
              <button
                onClick={() => cart.length > 0 && setShowPayment(true)}
                disabled={cart.length === 0}
                className="flex flex-col items-center justify-center gap-1 py-3 bg-gradient-to-r from-emerald-500 to-emerald-600 text-white rounded-xl hover:from-emerald-600 hover:to-emerald-700 transition-all font-semibold text-xs shadow-md active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed"
              >
        ...
        <div className="hidden lg:flex w-96 bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 p-6 flex-col shadow-sm">
          {/* Total Display */}
          <div className="mb-6 p-6 bg-gradient-to-br from-red-100 to-red-200 dark:from-red-900/30 dark:to-red-900/50 rounded-2xl border-2 border-red-300 dark:border-red-800 shadow-lg">
            <p className="text-sm font-black text-red-900 dark:text-red-100 mb-2 uppercase tracking-wider">JAMI SUMMA</p>
            <p className={`text-4xl font-black ${isReturnMode ? 'text-warning-900 dark:text-warning-200' : 'text-red-900 dark:text-red-100'}`}>
          ...
          <input
            ...
            className="w-full px-4 py-4 text-center text-xl font-mono font-bold bg-gray-50 dark:bg-gray-700 border-2 border-gray-200 dark:border-gray-600 rounded-2xl mb-4 focus:outline-none focus:border-red-500 focus:ring-4 focus:ring-red-500/20 dark:text-gray-100 transition-all"
          />
          ...
          <div className="grid grid-cols-4 gap-2 mb-4">
            {['7', '8', '9', 'C', '4', '5', '6','⌫', '1', '2', '3', '+', '0', '00', '.'].map((key) => (
              <button
                ...
                className={`
                  flex items-center justify-center rounded-xl text-xl font-bold transition-all active:scale-95 shadow-sm
                  ${key === 'C' ? 'bg-danger-500 text-white hover:bg-danger-600 hover:shadow-md' : ''}
                  ${key === '⌫' ? 'bg-warning-500 text-white hover:bg-warning-600 hover:shadow-md' : ''}
                  ${key === '+' ? 'bg-red-500 text-white hover:bg-red-600 row-span-2 hover:shadow-md' : ''}
                  ${!['C', '⌫', '+'].includes(key) ? 'bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-600 hover:shadow-md' : ''}
                  ${key === '+' ? 'h-full' : 'h-16'}
                `}
              >
          ...
          <div className="grid grid-cols-3 gap-2 mb-4">
            {!isReturnMode && (
              <button
                onClick={openSearch}
                className="flex items-center justify-center gap-2 px-3 py-3 bg-red-500 text-white rounded-xl hover:bg-red-600 transition-all font-semibold text-sm shadow-md"
              >
            ...
            <button
              onClick={toggleReturnMode}
              className={`flex items-center justify-center gap-2 px-3 py-3 rounded-xl transition-all font-semibold text-sm shadow-md ${
                isReturnMode
                  ? 'bg-warning-500 text-white hover:bg-warning-600'
                  : 'bg-warning-100 text-warning-700 hover:bg-warning-200 dark:bg-warning-900/30 dark:text-warning-400'
              }`}
            ...
            {isReturnMode && (
              <button
                ...
                className="flex items-center justify-center gap-2 px-3 py-3 bg-warning-100 text-warning-700 rounded-xl hover:bg-warning-200 transition-all font-semibold text-sm shadow-md dark:bg-warning-900/30 dark:text-warning-400"
              >
                <Search className="w-4 h-4" />
                <span>Qo'shish</span>
              </button>
            ...
            <button
              onClick={saveReceipt}
              className="flex items-center justify-center gap-2 px-3 py-3 bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 rounded-xl hover:bg-gray-200 dark:hover:bg-gray-600 transition-all font-semibold text-sm shadow-md"
            >
          ...
          <button
            ...
            disabled={cart.length === 0}
            className="w-full flex items-center justify-center gap-3 px-6 py-4 bg-gradient-to-r from-success-500 to-success-600 text-white rounded-2xl hover:from-success-600 hover:to-success-700 transition-all disabled:opacity-50 disabled:cursor-not-allowed font-bold text-lg shadow-lg hover:shadow-xl hover:scale-105"
          >
      ...
      <div className="lg:hidden sticky bottom-0 left-0 right-0 bg-white dark:bg-gray-800 border-t-2 border-gray-200 dark:border-gray-700 shadow-2xl z-20">
        {/* Action Buttons */}
        <div className="flex items-center gap-2 px-4 pt-3 pb-2 border-b border-gray-200 dark:border-gray-700">
          {!isReturnMode && (
            <button
              onClick={openSearch}
              className="flex-1 flex items-center justify-center gap-2 px-3 py-2.5 bg-red-500 text-white rounded-xl hover:bg-red-600 transition-all font-semibold text-sm shadow-md"
            >
              <Search className="w-4 h-4" />
              <span>Qidirish</span>
            </button>
          ...
          <button
            onClick={toggleReturnMode}
            className={`flex-1 flex items-center justify-center gap-2 px-3 py-2.5 rounded-xl transition-all font-semibold text-sm shadow-md ${
              isReturnMode
                ? 'bg-warning-500 text-white hover:bg-warning-600'
                : 'bg-warning-100 text-warning-700 hover:bg-warning-200 dark:bg-warning-900/30 dark:text-warning-400'
            }`}
          ...
          {isReturnMode && (
            <button
              onClick={openReturnSearch}
              className="flex-1 flex items-center justify-center gap-2 px-3 py-2.5 bg-warning-100 text-warning-700 rounded-xl hover:bg-warning-200 transition-all font-semibold text-sm shadow-md dark:bg-warning-900/30 dark:text-warning-400"
            >
              <Search className="w-4 h-4" />
              <span>Qo'shish</span>
            </button>
          ...
          <button
            onClick={saveReceipt}
            className="flex-1 flex items-center justify-center gap-2 px-3 py-2.5 bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 rounded-xl hover:bg-gray-200 dark:hover:bg-gray-600 transition-all font-semibold text-sm shadow-md"
          >
            <Save className="w-4 h-4" />
            <span>Saqlash</span>
          </button>
        ...
        <div className="flex items-center gap-4 p-4">
          <div className="flex-1 p-4 bg-gradient-to-br from-red-50 to-red-100 dark:from-red-900/20 dark:to-red-900/30 rounded-2xl border-2 border-red-200 dark:border-red-800">
            <p className="text-xs font-black text-red-900 dark:text-red-200 mb-1 uppercase tracking-wide">JAMI SUMMA</p>
            <p className={`text-2xl font-black ${isReturnMode ? 'text-warning-700 dark:text-warning-300' : 'text-red-900 dark:text-red-200'}`}>
              {total.toLocaleString()}
          ...
          <button
            onClick={() => setShowPayment(true)}
            disabled={cart.length === 0}
            className="flex flex-col items-center justify-center gap-1 px-6 py-3 bg-gradient-to-r from-success-500 to-success-600 text-white rounded-2xl hover:from-success-600 hover:to-success-700 transition-all disabled:opacity-50 disabled:cursor-not-allowed font-bold shadow-lg hover:scale-105"
          >
            <CreditCard className="w-6 h-6" />
            ...
            <div className="p-6 bg-white dark:bg-gray-800">
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h3 className="text-2xl font-black text-slate-900 dark:text-gray-100 mb-1">Mahsulot qidirish</h3>
                    <p className="text-sm font-bold text-slate-700 dark:text-gray-400">Nom yoki kod bo'yicha toping</p>
                  </div>
                </div>
                <button
            ...
            <div className="flex-1 overflow-auto p-4 bg-white dark:bg-gray-800">
              {isSearching ? (
                ...
                <div className="flex flex-col items-center justify-center py-12">
                  ...
                  <p className="text-lg font-bold text-slate-900 dark:text-gray-100">Mahsulot topilmadi</p>
