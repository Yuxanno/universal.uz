    ...
    <div className="min-h-screen bg-surface-50 pb-20 lg:pb-0">
      ...
      {showProductsModal && selectedWarehouse && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-2 lg:p-4 animate-fadeIn">
          ...
          <div className="bg-white dark:bg-surface-800 rounded-3xl shadow-2xl w-full h-full max-w-[98vw] max-h-[96vh] lg:max-w-[95vw] lg:max-h-[94vh] relative z-10 animate-scaleIn overflow-hidden flex flex-col border-2 border-surface-100 dark:border-surface-700">
            {/* Gradient Header */}
            <div className="bg-gradient-to-r from-brand-500 to-brand-600 px-4 lg:px-6 py-5">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 bg-white/20 backdrop-blur-sm rounded-xl flex items-center justify-center">
                    <WarehouseIcon className="w-5 h-5 text-white" />
                  ...
                  <div>
                    <h3 className="text-xl font-black text-white">{selectedWarehouse.name}</h3>
                    <p className="text-sm text-white/80">Ombordagi tovarlar</p>
                  </div>
                </div>
                <div className="flex items-center gap-3">
                  <div className="relative hidden lg:block">
                    ...
                    <input
                      ...
                      className="w-48 lg:w-64 pl-9 pr-4 py-2 bg-white/20 backdrop-blur-sm border border-white/30 rounded-xl text-sm text-white placeholder-white/60 focus:outline-none focus:border-white/50 focus:bg-white/30"
                    />
                  </div>
                  <button onClick={openAddProductModal} className="bg-white/20 backdrop-blur-sm hover:bg-white/30 text-white px-4 py-2 rounded-xl font-bold transition-all hover:scale-105 flex items-center gap-2">
                    <Plus className="w-4 h-4" />
      ...
      {showAddProductModal && selectedWarehouse && (
        <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 animate-fadeIn">
          ...
          <div className="bg-white dark:bg-surface-800 rounded-3xl shadow-2xl w-full max-w-lg relative z-10 animate-scaleIn overflow-hidden border-2 border-surface-100 dark:border-surface-700">
            {/* Gradient Header */}
            <div className="bg-gradient-to-r from-brand-500 to-brand-600 px-6 py-5">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-white/80">{selectedWarehouse.name} uchun</p>
                  </div>
                </div>
                <button onClick={closeAddProductModal} className="w-8 h-8 flex items-center justify-center rounded-xl bg-white/20 hover:bg-white/30 text-white transition-all hover:scale-110">
                  <X className="w-5 h-5" />
                </button>
              </div>
            </div>
            ...
            <form onSubmit={handleProductSubmit} className="p-6 space-y-5">
              <div>
                <label className="text-sm font-bold text-surface-700 dark:text-surface-300 mb-2 block">Kod</label>
                <input 
                  type="text" 
                ...
                />
                {codeError && (
                  <p className={`text-sm mt-1 font-semibold ${editingProduct ? 'text-danger-600' : 'text-warning-600'}`}>
                    {codeError}
                  </p>
                )}
              </div>
              <div>
                <label className="text-sm font-bold text-surface-700 dark:text-surface-300 mb-2 block">Nomi</label>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="text-sm font-bold text-surface-700 dark:text-surface-300 mb-2 block">Tan narxi (so'm)</label>
                ...
                <div>
                  <label className="text-sm font-bold text-surface-700 dark:text-surface-300 mb-2 block">Optom narxi (so'm)</label>
              ...
              <div className="border-t-2 border-surface-200 dark:border-surface-700 pt-5">
                <label className="text-sm font-bold text-surface-700 dark:text-surface-300 mb-3 block">Qop ma'lumotlari</label>
                <div className="space-y-3 bg-gradient-to-br from-surface-50 to-surface-100 dark:from-surface-700 dark:to-surface-800 p-4 rounded-2xl border-2 border-surface-200 dark:border-surface-600">
                  <div className="grid grid-cols-3 gap-3">
                    <div>
                      <label className="text-xs font-bold text-surface-600 dark:text-surface-400 mb-1 block">Qoplar soni</label>
                      <input
                        type="number"
                    ...
                    <div>
                      <label className="text-xs font-bold text-surface-600 dark:text-surface-400 mb-1 block">Har qopda</label>
                      <input
                        type="number"
                        className="input text-sm"
                        placeholder="20"
                    ...
                    <div>
                      <label className="text-xs font-bold text-surface-600 dark:text-surface-400 mb-1 block">Jami mahsulot</label>
                      <input
                        type="text"
                        className="input text-sm bg-surface-100 dark:bg-surface-600 font-bold"
                        placeholder="0"
              ...
              <div className="flex gap-3 pt-4">
                <button type="button" onClick={closeAddProductModal} className="btn-secondary flex-1 font-bold">Bekor qilish</button>
                <button type="submit" className="btn-primary flex-1 font-bold shadow-lg hover:shadow-xl" disabled={!!(editingProduct && codeError)}>
