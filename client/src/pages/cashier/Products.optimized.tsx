...
import './Products.optimized.css';

// Memoized Product Card Component with optimizations
const ProductCard = memo(({ 
  ...
  const handleDelete = useCallback(() => onDelete(product._id), [product._id, onDelete]);

  return (
    <div className="product-card bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 overflow-hidden hover:shadow-md transition-shadow">
      {/* Image */}
...
const ProductModal = memo(({ 
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      <div className="modal-overlay fixed inset-0 bg-black/50" onClick={onClose} />
      <div className="modal-content bg-white dark:bg-gray-800 rounded-2xl w-full max-w-md shadow-2xl relative z-10 max-h-[90vh] overflow-y-auto">
