...
export default function Login() {
  ...
  return (
    <div className="h-screen bg-gray-50 dark:from-slate-950 dark:to-slate-900 flex items-center justify-center p-4 overflow-hidden">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-12 pr-4 py-3.5 text-base font-semibold text-slate-900 dark:text-white bg-white dark:bg-slate-800 border-2 border-gray-300 dark:border-slate-600 rounded-xl transition-all focus:outline-none focus:border-red-500 focus:ring-4 focus:ring-red-500/10 dark:focus:ring-red-900/30 placeholder:text-slate-400 dark:placeholder:text-slate-500"
                    required
                  />
                </div>
              </div>
