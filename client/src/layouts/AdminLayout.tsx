    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      {mobileMenuOpen && (
        <>
          ...
          />
          <div className="lg:hidden fixed top-0 left-0 bottom-0 w-72 bg-white dark:bg-gray-800 z-50 shadow-2xl animate-slide-in-left">
            ...
            <div className="absolute bottom-0 left-0 right-0 p-3 border-t border-gray-100 dark:border-gray-700 bg-white dark:bg-gray-800 safe-bottom">
              ...
              <button
                ...
                className="flex items-center gap-3 w-full px-4 py-3 rounded-lg text-gray-500 hover:bg-danger-50 hover:text-danger-600 dark:text-gray-400 dark:hover:bg-danger-900/30 dark:hover:text-danger-400 transition-all duration-200"
              >
